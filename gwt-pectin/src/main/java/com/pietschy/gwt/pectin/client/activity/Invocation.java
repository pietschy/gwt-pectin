...
/**
 * This class represents one link in an interceptor chain.  Invocations allow {@link com.pietschy.gwt.pectin.client.activity.Interceptor}
 * instances to stop the execution of an activity.  In order to continue the execution of a command the interceptor
...
public class Invocation
{
    ...
    * the command will cancel the activity.
    *
